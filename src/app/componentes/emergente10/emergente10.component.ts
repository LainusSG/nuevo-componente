...
@Component({
  selector: 'app-emergente10',
  templateUrl: './emergente10.component.html',
  styleUrl: './emergente10.component.css'
})
export class Emergente10Component {
  ...
  dataset = [
    { name: "Canada", value: 351 },
    { name: "U.S.A", value: 153 },
    { name: "México", value: 426 },
    { name: "Brazil", value: 624 },
  ];
  ...
  getBase64ImageFromURL(url: string) {
    ...
    const pdfDefinition: any = {
      ...
      header:[
        ...
        {text: 'USO DE ESTERILIZADOR ', style: 'header2'},
      ...
      content: [
        ...
        {text: 'USO DE ESTERILIZADOR', style: 'titulo1'},
  ...
  images:{
    ...
    pdf.download('Uso de Esterilizador '+ dia + '/'+mes2+'/'+año + ' ('+ hora + '/'+ minutos + 'hr)');
