...
@Component({
  selector: 'app-emergente5',
  templateUrl: './emergente5.component.html',
  styleUrl: './emergente5.component.css'
})
export class Emergente5Component {
  ...
  getBase64ImageFromURL(url: string) {
    ...
    const pdfDefinition: any = {
      ...
      header:[
        ...
        {text: 'MERMAS POR CADUCIDAD ', style: 'header2'},
      ...
      content: [
        ...
        {text: 'MERMAS POR CADUCIDAD', style: 'titulo1'},
  ...
  images:{
    ...
    pdf.download('Mermas por Caducidad '+ dia + '/'+mes2+'/'+año + ' ('+ hora + '/'+ minutos + 'hr)');
