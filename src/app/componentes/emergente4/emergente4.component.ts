...
@Component({
  selector: 'app-emergente4',
  templateUrl: './emergente4.component.html',
  styleUrl: './emergente4.component.css'
})
export class Emergente4Component {
...
dataSource = ELEMENT_DATA;
  ...
  dataset = [
    ...
    { name: "U.S.A", value: 264 },
    { name: "México", value: 346 },
    { name: "Brazil", value: 598 },
  ];
  ...
  getBase64ImageFromURL(url: string) {
    ...
    const pdfDefinition: any = {
      ...
      header:[
        ...
        {text: 'INDICADOR DE SOLICITUDES DE ESTERILIZACIÓN ', style: 'header2'},
      ...
      content: [
        ...
        {text: 'INDICADOR DE SOLICITUDES DE ESTERILIZACIÓN ', style: 'titulo1'},
  ...
  images:{
    ...
    pdf.download('Indicador de Solicitudes de Esterilización '+ dia + '/'+mes2+'/'+año + ' ('+ hora + '/'+ minutos + 'hr)');
