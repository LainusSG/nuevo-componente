...
@Component({
  selector: 'app-emergente8',
  templateUrl: './emergente8.component.html',
  styleUrl: './emergente8.component.css'
})
export class Emergente8Component {
  ...
  dataset = [
    { name: "Canada", value: 321 },
    { name: "U.S.A", value: 123 },
    { name: "México", value: 351 },
    { name: "Brazil", value: 156},
  ];
  ...
  getBase64ImageFromURL(url: string) {
    ...
    const pdfDefinition: any = {
      ...
      header:[
        ...
        {text: 'INDICADOR DE PRIORIDAD DE PAQUETES ', style: 'header2'},
      ...
      content: [
        ...
        {text: 'INDICADOR DE PRIORIDAD DE PAQUETES', style: 'titulo1'},
  ...
  images:{
    ...
    pdf.download('Indicador de Prioridad de Paquetes '+ dia + '/'+mes2+'/'+año + ' ('+ hora + '/'+ minutos + 'hr)');
