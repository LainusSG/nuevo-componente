...
@Component({
  selector: 'app-emergente7',
  templateUrl: './emergente7.component.html',
  styleUrl: './emergente7.component.css'
})
export class Emergente7Component {
  ...
  getBase64ImageFromURL(url: string) {
    ...
    const pdfDefinition: any = {
      ...
      header:[
        ...
        {text: 'TIPOS DE PAQUETES PROCESADOS POR TURNO ', style: 'header2'},
      ...
      content: [
        ...
        {text: 'TIPOS DE PAQUETES PROCESADOS POR TURNO', style: 'titulo1'},
  ...
  images:{
    ...
    pdf.download('Tipos de Paquetes Procesados por Turno '+ dia + '/'+mes2+'/'+año + ' ('+ hora + '/'+ minutos + 'hr)');
