...
@Component({
  selector: 'app-emergente3',
  templateUrl: './emergente3.component.html',
  styleUrl: './emergente3.component.css'
})
export class Emergente3Component {
...
dataSource = ELEMENT_DATA;
  ...
  getBase64ImageFromURL(url: string) {
    ...
    const pdfDefinition: any = {
      ...
      header:[
        ...
        {text: 'PRODUCTIVIDAD POR QUIRÓFANO ', style: 'header2'},
      ...
      content: [
        ...
        {text: 'PRODUCTIVIDAD POR QUIRÓFANO', style: 'titulo1'},
  ...
  images:{
    ...
    pdf.download('Productividad por Quirófano '+ dia + '/'+mes2+'/'+año + ' ('+ hora + '/'+ minutos + 'hr)');
