...
@Component({
  selector: 'app-emergente1',
  templateUrl: './emergente1.component.html',
  styleUrl: './emergente1.component.css'
})
export class Emergente1Component {
  ...
  getBase64ImageFromURL(url: string) {
    ...
    const pdfDefinition: any = {
      ...
      header:[
        ...
        {text: 'PAQUETES PROCESADOS POR TURNO Y OPERADOR ', style: 'header2'},
      ...
      content: [
        ...
        {text: 'PAQUETES PROCESADOS POR TURNO Y OPERADOR', style: 'titulo1'},
  ...
  images:{
    ...
    pdf.download('Paquetes procesados por turno y operador '+ dia + '/'+mes2+'/'+año + ' ('+ hora + '/'+ minutos + 'hr)');
