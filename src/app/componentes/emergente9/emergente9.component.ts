...
@Component({
  selector: 'app-emergente9',
  templateUrl: './emergente9.component.html',
  styleUrl: './emergente9.component.css'
})
export class Emergente9Component {
  ...
  getBase64ImageFromURL(url: string) {
    ...
    const pdfDefinition: any = {
      ...
      header:[
        ...
        {text: 'CANTIDAD DE CIRUGÍAS POR DOCTOR Y QUIRÓFANO ', style: 'header2'},
      ...
      content: [
        ...
        {text: 'CANTIDAD DE CIRUGÍAS POR DOCTOR Y QUIRÓFANO', style: 'titulo1'},
  ...
  images:{
    ...
    pdf.download('Cantidad de Cirugías por Doctor y Quirófano '+ dia + '/'+mes2+'/'+año + ' ('+ hora + '/'+ minutos + 'hr)');
