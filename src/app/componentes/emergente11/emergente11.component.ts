...
@Component({
  selector: 'app-emergente11',
  templateUrl: './emergente11.component.html',
  styleUrl: './emergente11.component.css'
})
export class Emergente11Component {
  ...
  getBase64ImageFromURL(url: string) {
    ...
    const pdfDefinition: any = {
      ...
      header:[
        ...
        {text: 'PAQUETES POR ESTERILIZADOR ', style: 'header2'},
      ...
      content: [
        ...
        {text: 'PAQUETES POR ESTERILIZADOR' , style: 'titulo1'},
  ...
  images:{
    ...
    pdf.download('Paquetes por Esterilizador '+ dia + '/'+mes2+'/'+año + ' ('+ hora + '/'+ minutos + 'hr)');
