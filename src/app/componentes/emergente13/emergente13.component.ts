...
@Component({
  selector: 'app-emergente13',
  templateUrl: './emergente13.component.html',
  styleUrl: './emergente13.component.css'
})
export class Emergente13Component {
  ...
  dataset = [
    ...
    { name: "U.S.A", value: 263 },
    { name: "México", value: 295 },
  ...
  getBase64ImageFromURL(url: string) {
    ...
    const pdfDefinition: any = {
      ...
      header:[
        ...
        {text: 'TIEMPO DEL PAQUETE FUERA DE CEyE ', style: 'header2'},
      ...
      content: [
        ...
        {text: 'TIEMPO DEL PAQUETE FUERA DE CEyE', style: 'titulo1'},
  ...
  images:{
    ...
    pdf.download('Tiempo del Paquete Fuera de CEyE '+ dia + '/'+mes2+'/'+año + ' ('+ hora + '/'+ minutos + 'hr)');
