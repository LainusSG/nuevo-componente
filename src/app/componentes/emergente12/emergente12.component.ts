...
@Component({
  selector: 'app-emergente12',
  templateUrl: './emergente12.component.html',
  styleUrl: './emergente12.component.css'
})
export class Emergente12Component {
  ...
  dataset = [
    { name: "Canada", value: 663 },
    { name: "U.S.A", value: 336 },
    { name: "México", value: 445},
    { name: "Brazil", value: 553 },
  ];
  ...
  getBase64ImageFromURL(url: string) {
    ...
    const pdfDefinition: any = {
      ...
      header:[
        ...
        {text: 'NÚMERO DE PRUEBAS DE ESTERILIZACIÓN ', style: 'header2'},
      ...
      content: [
        ...
        {text: 'NÚMERO DE PRUEBAS DE ESTERILIZACIÓN', style: 'titulo1'},
  ...
  images:{
    ...
    pdf.download('Número de Pruebas de Esterilización '+ dia + '/'+mes2+'/'+año + ' ('+ hora + '/'+ minutos + 'hr)');
